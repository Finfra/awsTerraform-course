...
# 주의
* 서울 리전에서 작동 안하니까 ap-northeast-2에서 구현할 것.
...
ssh ubuntu@<ip1> consul members
ssh ubuntu@<ip1> curl localhost:8500/v1/catalog/nodes
ssh ubuntu@<ip2> hostname
ssh ubuntu@<ip3> hostname
